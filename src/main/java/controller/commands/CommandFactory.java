...
public class CommandFactory {
    ...
    static {
        ...
        actionMap.put("LOGIN_CHECK", new LoginCheckCommand(ServiceFactory.getUserService()));
        ...
        actionMap.put("SAVE_THE_RESULTS", new SaveTheResultCommand(ServiceFactory.getThemeService(),ServiceFactory.getTestService(), ServiceFactory.getAnswerService()));
        actionMap.put("SHOW_RESULTS", new GetStudentResultCommand(ServiceFactory.getUserService(),ServiceFactory.getTestService()));
        actionMap.put("REGISTER", new RegisterCommand(ServiceFactory.getUserService()));
